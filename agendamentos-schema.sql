-- Schema para criação da tabela de agendamentos

-- Tabela de disponibilidade semanal do trainer
...
CREATE INDEX IF NOT EXISTS idx_disponibilidade_trainer ON disponibilidade_trainer (id_trainer, dia_semana, ativo);
